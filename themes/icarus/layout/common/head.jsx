...
module.exports = class extends Component {
    render() {
        ...
        return <head>
            ...
            <style dangerouslySetInnerHTML={{ __html: `html{box-sizing:border-box;background-color:#f7f7f7;font-size:16px;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;min-width:300px;overflow-x:hidden;overflow-y:scroll;text-rendering:optimizeLegibility;text-size-adjust:100%;height:100%;-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;-ms-text-size-adjust:100%}*,*::before,*::after{box-sizing:inherit}body{color:#4a4a4a;font-size:1em;font-weight:400;line-height:1.5;font-family:'微軟正黑體','Microsoft jhenghei',sans-serif;min-height:100%;display:flex;flex-direction:column}body>.section{flex-grow:1}.navbar{background-color:#fff;min-height:3.25rem;position:relative;z-index:30}.navbar-brand,.navbar-tabs{align-items:stretch;display:flex;flex-shrink:0;min-height:3.25rem}.navbar-item{display:block;flex-grow:0;flex-shrink:0}.navbar-burger{color:#4a4a4a;cursor:pointer;display:block;height:3.25rem;position:relative;width:3.25rem;margin-left:auto}.navbar-main{box-shadow:0 4px 10px rgba(0,0,0,0.05)}.navbar-main .navbar-container{overflow-x:auto}.navbar-main .navbar-menu,.navbar-main .navbar-start,.navbar-main .navbar-end{align-items:stretch;display:flex;padding:0;flex-shrink:0}.navbar-main .navbar-menu{flex-grow:1;flex-shrink:0;overflow-x:auto}.navbar-main .navbar-start{justify-content:flex-start;margin-right:auto}.navbar-main .navbar-end{justify-content:flex-end;margin-left:auto}.navbar-main .navbar-item{display:flex;align-items:center;padding:1.25rem .75rem;margin:0}.section{padding:3rem 1.5rem}.columns{margin-left:-.75rem;margin-right:-.75rem;margin-top:-.75rem;display:flex}.columns:last-child{margin-bottom:-.75rem}.columns:not(:last-child){margin-bottom:calc(1.5rem - .75rem)}.column{display:block;flex-basis:0;flex-grow:1;flex-shrink:1;padding:.75rem}.container{flex-grow:1;margin:0 auto;position:relative;width:auto}@media screen and (min-width:1088px){.container{max-width:960px}}@media screen and (min-width:1280px){.container{max-width:1152px}}@media screen and (min-width:1472px){.container{max-width:1344px}}.card{background-color:#fff;box-shadow:0 4px 10px rgba(0,0,0,.05),0 0 1px rgba(0,0,0,.1);color:#4a4a4a;max-width:100%;position:relative}.card-content{background-color:transparent;padding:1.5rem}` }} />
            <link rel="preload" href={url_for('/css/' + variant + '.css')} as="style" onload="this.onload=null;this.rel='stylesheet'" />
            <noscript><link rel="stylesheet" href={url_for('/css/' + variant + '.css')} /></noscript>
