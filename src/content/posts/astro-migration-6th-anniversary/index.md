...
直到之前玩 [paperclip](https://github.com/paperclipai/paperclip) (用 AI 開公司的開源專案)，我嘗試用來優化這個部落格，他就一直開 PR 解決效能的問題，但每次我都要先合併後再重新部署才能實測。
...
![Hexo 時期手機版 PageSpeed 跑分：效能 71、無障礙 82、最佳做法 100、SEO 100](./pagespeed-mobile-before.png)

![Astro 遷移後手機版 PageSpeed 跑分：效能 99、無障礙 100、最佳做法 100、SEO 100](./pagespeed-mobile-after.png)
